<template>
  <div class="purchase-order-audit-timeline">
    <!-- Loading State -->
...
const getActionDescription = (log: any): string => {
  ...
  const actionDescriptions: Record<string, string> = {
    created: 'Purchase order was created',
    updated: 'Purchase order was updated',
    revised: 'Purchase order was revised',
    marked_ready: 'Purchase order was marked as ready',
    approved: 'Purchase order was approved',
    rejected: 'Purchase order was rejected',
    deleted: 'Purchase order was deleted',
  }
  
  return actionDescriptions[log.action] || 'Purchase order was modified'
}
